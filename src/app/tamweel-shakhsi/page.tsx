  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="relative pt-32 pb-20 bg-slate-50 border-b border-slate-100 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10 text-right">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="https://wa.me/966570856657" className="bg-saddad-gold text-slate-950 text-center px-8 py-4 rounded-xl font-bold text-base hover:bg-saddad-gold-light transition-all flex items-center justify-center gap-2 shadow-lg">
      ...
      <section className="py-20 max-w-4xl mx-auto px-4 text-right space-y-8 text-slate-700 font-light leading-loose">
        ...
        <p>يُعدّ التمويل الشخصي بالرياض من أكثر الخدمات المالية طلباً في المملكة العربية السعودية، إذ يلجأ إليه الموظفون وأصحاب الأعمال لتغطية احتياجاتهم المتنوعة، سواءً لشراء سيارة أو تجديد المنزل أو إقامة حفلات الأفراح أو سداد الالتزامات. في <strong className="font-bold text-slate-900">شركة نجد السداد للحلول المالية بالرياض</strong>، نعمل على تبسيط هذه العملية وتقليص وقت الإجراءات لمنحك الحرية المالية التي تستحقها.</p>

        <h3 className="text-xl font-bold text-slate-900">تمويل شخصي للموظفين الحكوميين بالرياض</h3>
        <p>يُعتبر موظفو الجهات الحكومية من أكثر الفئات استحقاقاً للتمويل الشخصي في الرياض نظراً لاستقرار دخلهم. نقدم لهم تمويلاً يصل حتى مليون ريال بأقساط شهرية تُحسم آلياً وبشروط ميسرة دون الحاجة لكفيل أو ضامن.</p>

        <h3 className="text-xl font-bold text-slate-900">تمويل شخصي للقطاع الخاص بالرياض بدون كفيل</h3>
        <p>إدراكاً منا للتحديات التي يواجهها موظفو القطاع الخاص، وفّرنا برامج تمويل شخصي خاصة بهم في الرياض بشروط مرنة، يشترط فيها فقط أن تكون الشركة مسجلة في وزارة الموارد البشرية وأن لا يقل الراتب الشهري عن 4,000 ريال.</p>

        <h3 className="text-xl font-bold text-slate-900">قرض شخصي إسلامي وشرعي بالرياض</h3>
        <p>جميع برامجنا للتمويل الشخصي بالرياض متوافقة مع أحكام الشريعة الإسلامية ومرخّصة من الهيئات الرقابية المختصة، وتعتمد على نظام المرابحة الإسلامية مما يجعلها حلالاً وخالية من الفوائد الربوية.</p>
      </section>
      ...
      <section className="py-20 bg-slate-900 text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4">
          ...
          <a href="https://wa.me/966570856657" className="bg-saddad-gold text-slate-950 px-10 py-4 rounded-xl font-bold text-base hover:bg-saddad-gold-light transition-all inline-flex items-center gap-2 shadow-lg">
