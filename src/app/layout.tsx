...
export const metadata: Metadata = {
  ...
  title: {
    default: "نجد السداد للحلول المالية والتطوير العقاري | تمويل شخصي وعقاري وتحصيل ديون بالرياض",
    template: "%s | نجد السداد للحلول المالية",
  },
  description: "نجد السداد بالرياض: تمويل شخصي حتى مليون ريال بدون كفيل، تمويل عقاري بدون دفعة أولى، سداد تعثرات بنكية، تحصيل ديون الشركات، وخدمات تحسين سمة. موافقة خلال 24 ساعة.",
  keywords: [
  ...
  authors: [{ name: "نجد السداد للحلول المالية والتطوير العقاري", url: siteUrl }],
  creator: "نجد السداد",
  publisher: "نجد السداد للحلول المالية والتطوير العقاري",
  alternates: { canonical: siteUrl },
  openGraph: {
    type: "website",
    locale: "ar_SA",
    url: siteUrl,
    siteName: "نجد السداد للحلول المالية والتطوير العقاري",
    title: "نجد السداد | تمويل شخصي وعقاري وتحصيل ديون بالرياض",
    description: "تمويل شخصي حتى مليون ريال، تمويل عقاري بدون دفعة أولى، سداد تعثرات وتحصيل ديون بالرياض.",
    images: [{ url: "/images/hero-banner.jpg", width: 1200, height: 630, alt: "نجد السداد للحلول المالية" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "نجد السداد | حلول مالية متكاملة بالرياض",
    description: "تمويل شخصي وعقاري وتحصيل ديون وسداد تعثرات بالرياض",
