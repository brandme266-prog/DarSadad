...
const articleContents: Record<string, {
  ...
  "حلول-تحصيل-ديون-الشركات-السعودية": {
    ...
    faqs: [
      { q: "كم عمولة شركة تحصيل الديون بالرياض؟", a: "تختلف العمولة حسب صعوبة وعمر الدين وتتراوح عادة بين 10% إلى 25% من المبلغ المُحصل فعلياً." },
      { q: "هل تقومون بتحصيل ديون الأفراد أم الشركات فقط؟", a: "تركيزنا الأساسي في شركة نجد السداد هو على ديون الشركات (B2B)، ونستقبل مديونيات الأفراد في حال تجاوزت المبالغ حداً معيناً وموثقة بسند لأمر." }
    ]
  },
