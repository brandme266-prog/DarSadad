...
const articleContents: Record<string, {
  ...
  "how-to-clear-simah-defaults-and-settle-loans": {
    ...
    faqs: [
      { q: "هل يمكن مسح اسمي من سمة بدون سداد المديونية؟", a: "لا، هذا غير ممكن قانونياً ومخالف للأنظمة. السداد الكلي أو الجدولة هما الطريق الوحيد لتحسين السجل." },
      { q: "هل نجد السداد تدفع عني التعثرات وتأخذ أقساط؟", a: "نحن نقدم استشارات مالية وندرس إمكانية استخراج قروض جديدة بناءً على وضعك الحالي، ثم سداد التعثر من القرض الجديد لتخفيف العبء المالي." }
    ]
  },
